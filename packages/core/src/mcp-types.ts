...
export type ToolCommandName = 'GetVaultContext' | 'ExecuteShell' | 'CreateNote' | 'UpdateNote' | 'ReportStatus' | 'CreateAgentVault' | 'SetVaultContext' | 'EnrichContext' | 'CommitState' | 'GetAllNodes' | 'ProcessFile' | 'PublishNode' | 'GetHistoryProof' | 'WikifyAndTag' | 'PinStateToIPFS';
