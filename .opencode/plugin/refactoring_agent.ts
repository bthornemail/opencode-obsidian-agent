...
export const RefactoringAgent: Plugin = async (ctx) => {
                ...
                async execute(args, toolCtx) {
                    ...
                    try {
                        ...
                        const originalNode = new TetraNode({
                            V1: "", // We don't have the original content, so we'll have to assume it from the update
                            V2: "", // This highlights a limitation to be fixed in a future version
                            V3: "",
                            V4: ""
                        });
                        ...
                        const updateMessage: NodeUpdateMessage = {
                            type: 'node_update',
                            nodeId: refactoredNode.nodeId, // Note: This creates a *new* node ID. An alternative would be to keep the old one.
